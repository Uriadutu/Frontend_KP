...
const InfoHakAksesModal = ({ setIsOpenModalAdd, selectedPegawai }) => {
  ...
  const hakAksesMapping = {
    lapasi: "Kepegawaian",
    pantai_disa: "Pendidikan Islam",
    aksesahu: "PHU",
    saria: "Bimas Islam",
  ...
  const activeHakAkses = Object.entries(hakAkses)
    .filter(([key, value]) => value === true) // Filter hanya hak akses aktif
    .map(([key]) => hakAksesMapping[key] || key.replace(/_/g, " ")); // Map ke nama sesuai, atau fallback ke nama asli
